...
class SoundboardyWindow(Handy.ApplicationWindow):
    __gtype_name__ = 'SoundboardyWindow'
    ...
    def generate_soundboard_view(self):
        ...
        soundboard.props.min_children_per_line = 4
        soundboard.props.margin_top = 20
